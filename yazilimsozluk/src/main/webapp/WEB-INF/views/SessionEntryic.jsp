...
<body>
 <input type="text" hidden style="display: none;" value="${entryId}" id="id"/>
<input style="display: none" hidden value="${user.userId}" id="userSession" />
<input style="display: none" hidden value="${user.username}" id="nameSession" />


 <input type="text" hidden style="display: none;" value="${yorumsayi}" id="yorumsayi"/>
 <input type="text" hidden style="display: none;" value="${pageId}" id="pageId"/>
    ...
    <div class="collapse navbar-collapse col-2 offset-lg-1 col-lg-2 col-md-1" id="navbarNavDropdown">
        <ul class="navbar-nav " style="">
            <li class="nav-item active">
                ...
                <a class="nav-link " href="#" style="color: black">ben</a>
            </li>
                <li class="nav-item"> 
...
<div id="popular" style="font-size: 14px;"></div>
    ...
    <!-- MAIN -->
    <div  class="col py-3">
            <a href="#" class="baslikk"><h5><b id="baslik"></b></h5></a>
   ...
   <hr>
      ...
      <div id="dis"></div>
          ...
          <ul class="pagination justify-content-end pagination pagination-sm">
                <li class="page-item">
                  
               
                  </li>
                         <c:if test = "${yorumsayi>1}">
           <li class="page-item"><a class="page-link" href="./../../baslik/${entryId}/0">1</a></li>
           <li class="page-item"><a class="page-link" href="./../../baslik/${entryId}/1">2</a></li>
      </c:if>
          <c:if test = "${yorumsayi>2}">
           <li class="page-item"><a class="page-link" href="./../../baslik/${entryId}/2">3</a></li>
      </c:if>
          <c:if test = "${yorumsayi>3}">
           <li class="page-item"><a class="page-link" href="./../../baslik/${entryId}/3">4</a></li>
      </c:if>
          <c:if test = "${yorumsayi>4}">
           <li class="page-item"><a class="page-link" href="./../../baslik/${entryId}/4">5</a></li>
      </c:if>
            <c:if test = "${yorumsayi5}">
           <li class="page-item"><a class="page-link" href="./../../baslik/${entryId}/5">6</a></li>
      </c:if>
              </ul>
...
<textarea rows="6" placeholder="yorumunuzu girin..." style="width: 85%;resize: none" id="comment"></textarea>
<br>
<button type="button" class="btn btn-info" onclick="addComment()">gönder</button>
<br>
<br>
<br>
    </div>
...
<script src="./../../assets/js/entryic.js"></script>
<script src="./../../assets/js/commentGonder.js"></script>
<script src="./../../assets/js/SessionpopularEntryic.js"></script>
