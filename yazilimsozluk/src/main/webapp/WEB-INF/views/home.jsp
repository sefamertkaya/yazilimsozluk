...
<head>
  ...
  <title>yazilimsozluk-anasayfa</title>
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top navbar-fixed-width">
   ...
   <div class="container-fluid">
        		...
        		<span class="navbar-toggler-icon"></span>
    				...
    				<input type="text" style="" class="form-control col-6 offset-lg-1 col-lg-5 col-md-3" placeholder="Aramak istediğiniz şeyi yazın" id="haydiara">
			         <br>
			         <br> 
                <input type="button" style="margin-left:10px;" class="btn btn-info col-md-1 col-2 " onclick="search()" value="Ara">
    ...
    <!-- MAIN -->
    <div  class="col py-3" id="yakalaentry">
