    ...
    <div  class="col py-3">
        ...
        <br>
            <div class="form-group" >
                    ...
                    <button class="btn btn-info" style="margin-left: 10px;width: 160px" onclick="controlUser()">Haydi!</button>
                    <br>
                    <br>
					<a href="sifrehatirlat" style="font-size: 13px;margin-left: 45px;">şifremi unuttum</a>                    
                  </div>
