...
<body>
 ...
 <input type="text" hidden style="display: none;" value="${userId}" id="recipientId"/>
 
 <input type="text" hidden style="display: none;" value="${user.userId}" id="senderId"/>
<nav class="navbar navbar-expand-md navbar-dark fixed-top navbar-fixed-width">
 ...
 <li class="nav-item"> 
              <a class="nav-link " href="cikis" style="color: black">mesaj</a>
            </li>
        </ul>
    </div>
</div>
...
<div id="popular" style="font-size: 14px;"></div>
    ...
    <div  class="col py-3">
	  <div class="mesajlar">
<h5><b style="color: crimson">${us.username}</b></h5> 
      <ul class="list-group" style="font-size: 13px;width: 95%" id="mesajalani">
      
      </ul>
    
    </div>
    <br>
    <textarea  class="form-control" style="resize: none;width: 80%;float: left;" placeholder="Mesajınızı yazın...." id="mesajic"></textarea>
    <button type="button" class="btn btn-outline-primary" style="margin-left: 5px" onclick="gonder()">Gönder!</button>
