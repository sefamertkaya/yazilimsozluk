...
<nav class="navbar navbar-expand-md navbar-dark fixed-top navbar-fixed-width">
   ...
   <div class="container-fluid">
    ...
    <div  class="col py-3">
                      ...
                      <h4>gel şifreni hatırlatalım</h4>
        <br>
            <div class="form-group" >
                    <label for="usr">kullanıcı adın :</label>
                    <input type="text" class="form-control" id="userisim" style="width: 300px"> 
            
                    <br>

                    <button class="btn btn-info" style="margin-left: 10px;width: 160px" onclick="sifreYolla()">yeni şifre istiyorum!</button>
                    
                    <br>
                   <br>
                    <p style="font-size: 14px;color: red">** Şifrenizi e-posta adresinize gönderilecek linkten sıfırlayabilirsiniz.</p>     
                        
                     <br>
                     
                     <div class="alert alert-info" style="width: 90%;font-size: 13px;display:none" id="bekleme"> 
    <strong>Yönlendiriliyorsunuz!</strong> Lütfen bekleyin...

  </div>   
  
    <div class="alert alert-danger" style="width: 90%;font-size: 13px;display:none" id="hata"> 
    <strong>Kullanıcı Hatası!</strong> Böyle bir kullanıcı mevcut değil...

  </div>   
  
  
  <div class="alert alert-success" style="width: 90%;font-size: 13px;display:none" id="finito"> 
    <strong>Tamamdır!</strong> E-Postanız gönderildi ,şifrenizi değiştirebilirsiniz, lütfen e-posta adresinizi kontrol edin...
