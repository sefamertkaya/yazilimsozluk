...
<nav class="navbar navbar-expand-md navbar-dark fixed-top navbar-fixed-width">
   ...
   <hr>
      <a href="${userId}" class="userbaslik"><h5><b style="color: crimson" id="name"></b></h5> </a>
      <p style="font-size: 12px;"><span title="bu kadar sayıda başlık açmış.">${entrysayi} entry </span> | <span title="bu kadar beğenmişler!">${ucursayi} kez uçuruldu</span> | <span title="bu kadar beğenmemişler!">${devirsayi} kez devirildi</span> | </p>
...
<script src="./../lib/js/jquery.min.js"></script>
 ...
 <script src="./../assets/js/profil.js"></script>
  <script src="./../assets/js/PopularEntryProfil.js"></script>
   <script src="./../assets/js/EntryAndComment.js"></script>
</body>
</html>
