...
<body >
<input style="display: none" hidden value="${userId}" id="profilid" />
    ...
    <div class="collapse navbar-collapse col-2 offset-lg-1 col-lg-2 col-md-1" id="navbarNavDropdown">
        <ul class="navbar-nav " style="">
            ...
            <li class="nav-item active">
                ...
                <a class="nav-link " href="${user.userId}" style="color: black">ben</a>
                        </li>
 <li class="nav-item"> 
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block col-3" >
        <ul class=" sticky-top sticky-offset sidebar-liste" style="">
			...
			<div id="popular" style="font-size: 14px;">
   ...
   <hr>
      <a href="${user.userId}" class="userbaslik"><h5><b style="color: crimson" id="name"></b></h5> </a>
 
      <p style="font-size: 12px;"><span title="bu kadar sayıda başlık açmış.">${entrysayi} entry </span> | <span title="bu kadar beğenmişler!">${ucursayi} kez uçuruldu</span> | <span title="bu kadar beğenmemişler!">${devirsayi} kez devirildi</span> | <a href="./../mesaj/${userId}">mesaj yolla</a> </p>

         <hr>


        <p><h4 style="font-style: italic;font-size: 16px;color:#5cb85c; text-decoration: underline;">açtığı başlıklar</h4></p>

<div id="basliklar"></div>
        
<hr>
<p><h4 style="font-style: italic;font-size: 16px;color:#5cb85c; text-decoration: underline;">attığı yorumlar</h4></p>
<div id="yorumlar"></div>
...
<script src="./../lib/js/jquery.min.js"></script>
 ...
 <script src="./../assets/js/profil.js"></script>
  ...
  <script src="./../assets/js/SessionEntryAndComment.js"></script>
</body>
</html>
