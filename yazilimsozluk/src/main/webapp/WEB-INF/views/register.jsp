...
<head>
  ...
  <title>yazilimsozluk- üye ol</title>
...
<div id="popular" style="font-size: 14px;"></div>
    ...
    <div  class="col py-3">
      ...
      <h4>gel hele seni bi kaydedelim</h4>
	
        <br>
            <div class="form-group" >
                    <label for="usr">E-Posta :</label>
                    <input type="text" class="form-control" id="email" style="width: 300px"> 
                    <br>
                    ...
                    <br>
                    <label for="pwd">Cinsiyet :</label>
                    <br>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" onclick="clickErkek()">Erkek</button>
                        <button type="button" class="btn btn-default" onclick="clickKadin()">Kadın</button>
                      </div>
                    <br>
                    <br>
                    <label><input type="checkbox" value="">Kullanıcı sözleşmesini okudum.(yalan)</label>
                    <br>
                    <br>
                    <button class="btn btn-info" style="margin-left: 10px;width: 160px" onclick="addUser()">Üye Yap!</button>
                  </div>
